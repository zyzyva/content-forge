            ...
            >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label class="form-control w-full">
                  ...
                  />
                  <span
                    :for={msg <- Enum.map(f[:url].errors, &translate_error/1)}
                    class="text-xs text-error mt-1"
                  >
                    {msg}
                  </span>
              ...
              >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <label class="form-control w-full">
                    ...
                    />
                    <span
                      :for={msg <- Enum.map(f[:wp_site_url].errors, &translate_error/1)}
                      class="text-xs text-error mt-1"
                    >
                      {msg}
                    </span>
                  ...
                  <label class="form-control w-full">
                    ...
                    />
                    <span
                      :for={msg <- Enum.map(f[:wp_username].errors, &translate_error/1)}
                      class="text-xs text-error mt-1"
                    >
                      {msg}
                    </span>
                  ...
                  <label class="form-control w-full md:col-span-2">
                    ...
                    <span
                      :for={msg <- Enum.map(f[:wp_app_password].errors, &translate_error/1)}
                      class="text-xs text-error mt-1"
                    >
                      {msg}
                    </span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <label class="form-control w-full">
                    ...
                    >
                      <option
                        value="none"
                        selected={
                          f[:generic_auth_type].value == "none" || f[:generic_auth_type].value == nil
                        }
                      >
                        None
                      </option>
                  ...
                  <label :if={f[:generic_auth_type].value == "bearer"} class="form-control w-full">
                    ...
                    <input
                      ...
                      value={
                        Phoenix.HTML.Form.normalize_value("text", f[:generic_bearer_token].value)
                      }
                  ...
                  <label :if={f[:generic_auth_type].value == "basic"} class="form-control w-full">
                    ...
                    <input
                      ...
                      value={
                        Phoenix.HTML.Form.normalize_value("text", f[:generic_basic_username].value)
                      }
                  ...
                  <label :if={f[:generic_auth_type].value == "basic"} class="form-control w-full">
                    ...
                    <input
                      ...
                      value={
                        Phoenix.HTML.Form.normalize_value("text", f[:generic_basic_password].value)
                      }
              ...
              <table class="table table-sm">
                ...
                <tbody>
                  <tr :for={webhook <- @webhooks} class={if not webhook.active, do: "opacity-50"}>
                    ...
                    <td>
                      <span
                        :if={webhook.hmac_secret && webhook.hmac_secret != ""}
